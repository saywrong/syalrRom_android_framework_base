...
#include <libspy/spy_export.h>
// #define BUFLEN 1024
// #define  SYLAR_LOG_TAG "sylar_zygote"
...
//         if(read_count>0){
//               int  processIndex=0; for(processIndex=0;processIndex<strlen(buffer);processIndex++){
...
public:
    ...
    {
		// Add by sylar
		// this method will be excute just after a  app
		// process start, see [AndroidRuntime] class.
		// we can monitoer app startup, and also we can do
		// something before app's code being excute, like
		// load .so, hook, etc.
        spy_init();
        
		// char buf[256];
		// getProcessName(buf);
		// DEBUG_PRINT("sylar: Package [ %s ] is starting\n", buf);
